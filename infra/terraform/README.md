...
- `https://github.com/Bh-an/sc-tf-ec2-service-module.git//terraform/modules/network?ref=v0.1.0`
- `https://github.com/Bh-an/sc-tf-ec2-service-module.git//terraform/modules/ec2-docker-service?ref=v0.1.0`
